                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre"
                                required value="<?php echo $categoria['nombre']?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="padre" name="padre"
                                value="<?php echo $categoria['padre']?>">
                        </div>
                        <?php if(!empty($categoria['padre'])) : ?>
                        <div class="form-group">
                        ...
                        <div class="modal-footer center">
                            <button type="submit" class="btn btn-info" name="insert">Modificar Categoria</button>
                        </div>
                    </form>
                </div>
            </div>
